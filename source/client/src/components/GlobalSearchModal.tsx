    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl p-0 gap-0 overflow-hidden">
        <div className="flex items-center border-b px-4 py-3 pr-12">
          ...
          />
          <kbd className="ml-2 pointer-events-none inline-flex h-6 select-none items-center gap-1 rounded border bg-muted px-2 font-mono text-xs text-muted-foreground">
            esc
          </kbd>
        </div>
          ...
          {query.length < 2 ? (
            <div className="p-8 text-center text-muted-foreground">
              ...
              <p className="text-xs mt-1 opacity-70">
                Press <kbd className="px-1 py-0.5 rounded bg-muted font-mono text-xs">Option</kbd> + <kbd className="px-1 py-0.5 rounded bg-muted font-mono text-xs">Space</kbd> to open this dialog
              </p>
            </div>
          ) : isLoading ? (
            <div className="p-8 text-center text-muted-foreground">
            ...
            <div className="py-2">
              ...
              {results?.projects && results.projects.length > 0 && (
                <div>
                  <div className="px-4 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-t mt-2 pt-4">
                    Projects
                  </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {client.email && (
                            <p className="text-xs text-muted-foreground truncate" data-sensitive>
                              {client.email}
                            </p>
                          )}
                        </div>
