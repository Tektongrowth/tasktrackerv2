...
export const welcomeSteps: WelcomeStep[] = [
  ...
  },
  {
    ...
    description: 'Get instant notifications on your phone via Telegram when someone mentions you in a task. You can even reply directly from Telegram! Go to My Settings to connect your account.',
  },
  {
    id: 'admin-settings',
    icon: 'Settings',
...
export const spotlightTours: TourDefinition[] = [
  ...
  },
  {
    ...
    description: 'Connect Telegram for mobile notifications',
    path: '/my-settings',
    steps: [
      {
        id: 'telegram-section',
        ...
        description: 'Click "Connect Telegram" to link your account. You\'ll be taken to Telegram where you tap "Start" to complete the connection.',
        placement: 'bottom',
      },
      {
        ...
        description: 'Once connected, you\'ll receive Telegram messages when someone @mentions you in a task comment, assigns you to a task, or sends you a chat message.',
        placement: 'bottom',
      },
      {
        id: 'telegram-reply',
        target: 'telegram-section',
        title: 'Replying from Telegram',
        description: 'When you receive a mention notification, swipe left on the message (or long-press) to reply. Your reply becomes a comment on the task, automatically mentioning the person who tagged you.',
        placement: 'bottom',
      },
      {
        id: 'telegram-mention',
        target: 'telegram-section',
        title: 'Mentioning Others',
        description: 'To mention someone else in your reply, type @theirname. For example: "@alice looks good!" will mention Alice instead of the original sender.',
        placement: 'bottom',
      },
    ],
  },
